...
plot.beta <- function(PS = 1, PF = 1, k = 0, n = 0, null = NULL, CI = NULL) {
                ...
                x = seq(0, 1, .0001) ##Set up for creating the distributions
        ...
        axis(1, at = seq(0,1,.1)) #adds custom x axis
        ...
        ##Calculate and report BF using Savage-Dickey density ratio
        if(mode(null) == "numeric"){
                ...
                return( list("BF01" = null.H1/null.H0, "BF10" = null.H0/null.H1,
                             "'CI'% cred lower" = CI.low, "'CI'% cred upper" = CI.high))
        }
}